%% @author Korney
%% @doc @todo Add description to ownerLogger.
...
handle_event({complain},State)->
	error_logger:info_msg("Owner: hey PM, make it work ~n",[]),
	{ok, State};

handle_event({fixReady},State)->
	error_logger:info_msg("Owner: sending fix, continue the business conversation ~n",[]),
	{ok, State};
