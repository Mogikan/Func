%% @author Korney
%% @doc @todo Add description to testerLogger.
...
handle_event({test},State)->
	error_logger:info_msg("Tester: received task ~n",[]),
	{ok, State};

handle_event({tested},State)->
	error_logger:info_msg("Tester: Looks good ~n",[]),
	{ok, State};
